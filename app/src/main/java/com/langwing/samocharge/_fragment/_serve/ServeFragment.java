...
import com.langwing.samocharge._activity._serve.ServeDetailActivity;
import com.langwing.samocharge._activity._serve.ServeMoneyActivity;
...
public class ServeFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void initView(View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.service_detail_bt).setOnClickListener(this);
        view.findViewById(R.id.serve_myMoney).setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.service_detail_bt:
                toActivity(ServeDetailActivity.class);
                break;
            case R.id.serve_myMoney:
                toActivity(ServeMoneyActivity.class);
                break;
