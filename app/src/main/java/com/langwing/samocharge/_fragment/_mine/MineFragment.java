...
import com.langwing.samocharge._activity._mywallet.MyWalletActivity;
...
public class MineFragment extends BaseFragment implements View.OnClickListener, IMineContract.IMineView {
    ...
    private void initMethod() {
        recordCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toActivity(RecordChargeActivity.class);
            }
        });
    }
...
//                break;
            case R.id.rl_consumer_hotline:
                ...
                toActivity(MyContactActivity.class);
                break;
